...
MODEL                   = Subsystem
MODULES                 = Subsystem_sf.c rtGetInf.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\Subsystem_sf.mexw64
MAKEFILE                = Subsystem.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2023b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2023b
START_DIR               = C:\MATLAB_Doc\test\testDebugSFcn
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:Subsystem_sf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
Subsystem_sf.obj : $(START_DIR)\Subsystem_sfcn_rtw\Subsystem_sf.c
	@cmd /C "echo ### Compiling $(START_DIR)\Subsystem_sfcn_rtw\Subsystem_sf.c
	$(CC) $(CFLAGS) $(START_DIR)\Subsystem_sfcn_rtw\Subsystem_sf.c

rtGetInf.obj : $(START_DIR)\Subsystem_sfcn_rtw\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\Subsystem_sfcn_rtw\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\Subsystem_sfcn_rtw\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\Subsystem_sfcn_rtw\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\Subsystem_sfcn_rtw\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\Subsystem_sfcn_rtw\rtGetNaN.c
