###########################################################################
## Makefile generated for component 'myTopMdl23b'. 
## 
## Makefile     : myTopMdl23b.mk
## Generated on : Fri Apr 19 11:45:20 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\myTopMdl23b.exe
...
MODELREF_LINK_RSPFILE     = myTopMdl23b_ref.rsp
COMPILER_COMMAND_FILE     = myTopMdl23b_comp.rsp
CMD_FILE                  = myTopMdl23b.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\myTopMdl23b.exe
...
DEFINES_STANDARD = -DMODEL=myTopMdl23b -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\myTopMdl23b_ert_rtw\myTopMdl23b.c

MAIN_SRC = $(START_DIR)\myTopMdl23b_ert_rtw\ert_main.c
...
MODELREF_LIBS = C:\MATLAB_Doc\test\sharedUtilCrossRelease\mdl23b\slprj\ert\myMdl20awSharedUtil\myMdl20awSharedUtil_rtwlib.lib
...
{$(START_DIR)\myTopMdl23b_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\myTopMdl23b_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\myTopMdl23b_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\myTopMdl23b_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ert_main.obj : "$(START_DIR)\myTopMdl23b_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\myTopMdl23b_ert_rtw\ert_main.c"


myTopMdl23b.obj : "$(START_DIR)\myTopMdl23b_ert_rtw\myTopMdl23b.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\myTopMdl23b_ert_rtw\myTopMdl23b.c"
